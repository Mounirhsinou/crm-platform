<?php $pageTitle = 'Modify Task'; ?>
<?php require_once APP_PATH . '/views/layouts/header.php'; ?>

<div class="row mb-4 align-items-center">
    <div class="col">
        <h1 class="h4 mb-1">Update Assignment</h1>
        <p class="text-muted small mb-0">Refining parameters for an existing workflow directive</p>
    </div>
    <div class="col-auto">
...
<div class="row justify-content-center">
    <div class="col-lg-10 col-xl-9">
        <form action="<?php echo APP_URL; ?>/tasks/edit/<?php echo $task['id']; ?>" method="POST">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    ...
                                    id="title" name="title" value="<?php echo Security::escape($task['title']); ?>"
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control bg-light border-light" id="description" name="description"
                                    rows="5"
                                    placeholder="Detailed instructions or background information..."><?php echo Security::escape($task['description']); ?></textarea>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="client_id" id="client_id" class="form-select bg-white border">
                                        ...
                                        <?php foreach ($clients as $client): ?>
                                            <option value="<?php echo $client['id']; ?>" <?php echo ($task['client_id'] == $client['id']) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="deal_id" id="deal_id" class="form-select bg-white border">
                                        ...
                                        <?php foreach ($deals as $deal): ?>
                                            <option value="<?php echo $deal['id']; ?>" <?php echo ($task['deal_id'] == $deal['id']) ? 'selected' : ''; ?>>
                ...
                <div class="col-md-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date"
                                    ...
                                    id="due_date" name="due_date" value="<?php echo $task['due_date']; ?>" required>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="form-check p-2 border rounded-3 bg-white d-flex align-items-center">
                                        <input class="form-check-input ms-0 me-2" type="radio" name="priority"
                                            id="p_low" value="low" <?php echo ($task['priority'] === 'low') ? 'checked' : ''; ?>>
                                        <label class="form-check-label small fw-medium text-muted" for="p_low">Low
                                            Priority</label>
                                    </div>
                                    <div class="form-check p-2 border rounded-3 bg-white d-flex align-items-center">
                                        <input class="form-check-input ms-0 me-2" type="radio" name="priority"
                                            id="p_medium" value="medium" <?php echo ($task['priority'] === 'medium') ? 'checked' : ''; ?>>
                                        <label class="form-check-label small fw-medium text-primary"
                                            for="p_medium">Standard (Medium)</label>
                                    </div>
                                    <div class="form-check p-2 border rounded-3 bg-white d-flex align-items-center">
                                        <input class="form-check-input ms-0 me-2" type="radio" name="priority"
                                            id="p_high" value="high" <?php echo ($task['priority'] === 'high') ? 'checked' : ''; ?>>
                            ...
                            <div class="mb-0">
                                <label for="status" class="form-label small fw-medium">Completion Status</label>
                                <select name="status" id="status" class="form-select bg-white border">
                                    <option value="pending" <?php echo ($task['status'] === 'pending') ? 'selected' : ''; ?>>Active (Pending)</option>
                                    <option value="completed" <?php echo ($task['status'] === 'completed') ? 'selected' : ''; ?>>Archived (Completed)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm sticky-top" style="top: 100px;">
                        <div class="card-body p-4 text-center">
                            <h6 class="fw-bold mb-3 small text-uppercase ls-wide text-muted">Synchronize</h6>
                            <p class="small text-muted mb-4 px-2">Ensure all linkable entities are correct before
                                committing changes to the registry.</p>

                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-sm py-2">
                                    <i class="bi bi-check2-circle me-1"></i> Sync Task Data
                                </button>
